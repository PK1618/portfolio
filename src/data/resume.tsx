  ...
  education: [
    {
      ...
      logoUrl: "https://rightpath.com.np/uploads/university/16921791341928936513.jpg",
      start: "2023",
      end: "2024",
    },
    {
  ...
  projects: [
    {
      ...
      dates: "Launched Early 2026",
      active: true,
      description:
        "Solo-built and production-deployed full-stack movie and OTT discovery platform on AWS (ECS Fargate, ALB, RDS, Secrets Manager, ECR). Resolved 8 production-grade issues including CORS conflicts in Spring Boot Security, Google OAuth redirect misconfiguration, JWT/SecurityContext race conditions, and sessionStorage-to-localStorage migration during OAuth flows.",
      roadmap: [
        "Taste matching: embedding-based user similarity using cosine distance to connect people with overlapping film taste",
        "Movie chat rooms: release-day discussion spaces tied to specific titles, opening when a film drops and archiving after the weekend",
      ],
      technologies: [
        "Spring Boot", "React", "TypeScript", "PostgreSQL",
        "AWS ECS Fargate", "AWS RDS", "Docker", "GitHub Actions", "Claude API",
      ],
      links: [
        {
          type: "Website",
    ...
    },
    {
      ...
      technologies: ["React.js", "JavaScript", "TailwindCSS", "MongoDB", "OpenAI DALL-E API", "Express.js"],
      links: [
        {
          type: "Website",
          href: "https://aiimagecheymowa.netlify.app/",
      ...
      image: "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExeTZ6Nnlla2V3MjZyeTFhMjZydzdxbjUwdjl0amxldHI3YXVvMDIxNyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/dtjx21QRZ2nrgYz3iA/giphy.gif",
      video: "",
    },
    {
      ...
      technologies: ["React.js", "Node.js", "Express", "Stream API", "Axios", "Giphy"],
      links: [
        {
          type: "Website",
          href: "https://universitytalks.netlify.app/",
      ...
      image: "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExYjcydWYzczJvejQ2ZDJta2JmMmxpY2phMDVocDNhd2VicW4wYmZ1YSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/S65QkXAcdXvF1o9gHk/giphy.gif",
      unoptimized: true,
      video: "",
    },
    {
      ...
      active: true,
      description:
        "Analyzed web traffic patterns to detect anomalies and forecast future trends using LSTMs and XGBoost. Applied EDA and time series forecasting on historical data to identify unusual traffic patterns.",
      technologies: ["Python", "TensorFlow", "Keras", "XGBoost", "Sklearn", "matplotlib", "seaborn"],
      links: [
        {
          type: "Source",
      ...
      image: "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExc3Zrb2Znbnc3YXdsbmdqYTg2M3RpdzFiYW5vOHB4MWp4eHVpd2tyZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/gSVW7TwUMEcDu/giphy.gif",
      video: "",
    },
    {
      ...
      image: "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExZmNnZWZ2M2U0dGZvbDI2d3Uxamd5b2c5bjkya2x2d21oaHVhbjRidSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/2ZVrNVOtaM2q1zluYs/giphy.gif",
      unoptimized: true,
      video: "",
    },
    {
      ...
      image: "https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExMTU4MmVkYWJpZm80ZWlqbDZtNzh1eXVoMDJ1dnU3bnV3MHE1ZHFrMCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l0K4pfi9qpnKQU3VC/giphy.gif",
      video: "",
    },
  ],
  ...
  certifications: [
    {
      ...
      description: (
        <>
          ...
          Data Visualization, Evolutionary Computation, and Interpretable Machine Learning.
        </>
      ),
      image: "https://64.media.tumblr.com/aa42776428824d72a6a22d1f656547ba/tumblr_msus7mPN9H1rwgdwdo1_400.png",
      links: [
        { title: "GitHub", icon: <Icons.github className="h-4 w-4" />, href: "https://github.com/PK1618/AI_Final_Project" },
        { title: "GitHub", icon: <Icons.github className="h-4 w-4" />, href: "https://github.com/PK1618/DeepLearing" },
        { title: "GitHub", icon: <Icons.github className="h-4 w-4" />, href: "https://github.com/PK1618/Interpretability_of_ML" },
      ],
    },
    {
      ...
      image: "https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/http://coursera-university-assets.s3.amazonaws.com/74/fa9028074941789429dfc1d1b71ddf/gc-logo-360x360.png?auto=format%2Ccompress&dpr=1&w=56px&h=56px&auto=format%2Ccompress&dpr=1",
      links: [
        { title: "Link", icon: <Icons.globe className="h-4 w-4" />, href: "https://coursera.org/share/0ca1fbe1ff55172028b9e44574782227" },
      ],
    },
    {
      title: "Microsoft C#",
      ...
      image: "https://miro.medium.com/v2/resize:fit:1400/1*fMCdGCokXoh8CECCD7j9Og.png",
      links: [
        { title: "Link", icon: <Icons.globe className="h-4 w-4" />, href: "https://learn.microsoft.com/en-us/users/satyapavankalyangude-7067/transcript/d5egwco8jpkkrnm" },
      ],
    },
    {
      ...
      image: "https://play-lh.googleusercontent.com/S4ohmoe87D7H9VcEmi_L_Bl_RGoxZC51jwnW1aWW89tpFekZYOTU1hfdtH6_Lu9YyKOJ",
      links: [],
    },
  ],
} as const;